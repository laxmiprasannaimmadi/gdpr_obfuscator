...
def obfuscate_json(data, pii_fields):
    ...
    input_json_dict = json.DictReader(StringIO(data))

    print(f'input_json_dict.fieldnames:', input_json_dict.fieldnames)

    input_json_dict.fieldnames = [x.lower() for x in input_json_dict.fieldnames]
    print(f'input_json_dict.fieldnames after lowercase:',input_json_dict.fieldnames)
    ...
    print(f'masked_data',masked_data)
    masked_bufer = StringIO()
    writer = json.DictWriter(masked_bufer, input_json_dict.fieldnames)
    writer.writeheader()
    writer.writerows(masked_data)
